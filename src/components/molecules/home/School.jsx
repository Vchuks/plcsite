        ...
        <div className="w-10/12 m-auto lg:w-full flex flex-col lg:flex-row gap-10 lg:gap-8">
          <div data-aos="zoom-in-up" data-aos-duration="2000">
            <div className="relative w-full school p-3 flex flex-col justify-between sb" >
                ...
                <TextLink className="text-corange" to="/school/product" body="View Courses"/>
            ...
            <div className="relative sb w-full school p-3 flex flex-col justify-between" >
                ...
                <TextLink className="text-corange" to="/school/data" body="View Courses"/>
            ...
            <div className="relative sb w-full school p-3 flex flex-col justify-between" >
                ...
                <Text className="sbox text-cdark py-2" body="Learn to build amazing websites & apps using modern frameworks."/>
                <TextLink className="text-corange" to="/school/programming" body="View Courses"/>
            ...
            <div className="relative sb w-full school p-3 flex flex-col justify-between"  >
                <div><Logo src="https://bulletsaintseverus911.s3.eu-west-3.amazonaws.com/IMG_4181.PNG" className="" alt=""/></div>
                <Text className="text-cdark text-lg font-['aristbold'] pt-4" body="Cloud School"/>
                <Text className="sbox text-cdark py-2" body="Understand modern Cloud Engineering, DevOps and Cyber Security"/>
                <TextLink className="text-corange" to="/school/cloud" body="View Courses"/>
