...
const EmergingHero = () => {
  return (
    <div className="flex flex-col items-center lg:flex-row bg-[#F5F6FA] px-4 lg:px-14 py-8 lg:py-0 gap-6 lg:gap-0">
      <div className="lg:w-2/4 2xl:w-full relative"data-aos="fade-up" data-aos-duration="2000" >
        <div className="hidden lg:block absolute w-[70px] -top-2 right-[40%] 2xl:right-[26%] xxxl:right-[50%] xxxl:w-[100px]">
          <Logo src={curve1} alt="" className="w-full" />
        </div>
        <div className="hidden rotate-[320deg] lg:block absolute w-[70px] top-[18%] left-[9%] xxxl:top-[20%] xxxl:left-[7%]  xxxl:w-[100px]">
          <Logo src={curve1} alt="" className="w-full" />
        </div>
        <div className="hidden lg:block absolute w-[40px] -left-[6%] top-0 2xl:-left-16 xxxl:w-[60px]">
