...
const Learning = () => {
  return (
    <div className="px-4 lg:px-14 py-20 lg:py-14 learn-box">
      ...
      <div className="flex flex-col lg:flex-row gap-14 lg:gap-4 justify-center py-8">
        ...
        <div className="relative h-full  learneach p-6">
          <div>
            <Logo
              src="https://bulletsaintseverus911.s3.eu-west-3.amazonaws.com/plc4.png"
              className=""
              alt=""
            />
          </div>
        ...
        <div className="relative h-full  learneach p-6">
          <div>
            <Logo
              src="https://bulletsaintseverus911.s3.eu-west-3.amazonaws.com/plc3.png"
              className=""
              alt=""
            />
          </div>
