      ...
      <div className="lg:w-[65%] xl:w-[70%] digitalcourse pt-8">
        ...
        <p className="text-corange font-[gbold] text-[30px] lg:text-[40px]">
            ...
            <span className="text-cgray text-xl lg:text-2xl font-[gmedium]">
              {" "}
              | N <span className="line-through">{numFor.format(digital[3]?.ngn_offset)}</span>
            </span>
          </p>
          <Text
        ...
        <div className="flex flex-col gap-6 my-4">
            ...
            <TextLink to="https://lively-cocada-4d1086.netlify.app/108" target="_blank" body={<button className="p-4 w-full bg-corange font-[gsemibold] rounded-[10px] text-white">
