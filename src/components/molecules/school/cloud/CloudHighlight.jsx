    ...
    <div className="bg-[#22205712] px-4 lg:px-14 py-10 lg:py-14">
      ...
      <div data-aos="fade-up" data-aos-duration="2000">
        <div className="w-11/12 lg:w-[450px] xxxl:w-[500px] h-full lg:h-[510px] flex flex-col justify-between m-auto bg-white relative border border-[#0D0032] rounded-ss-[8px] rounded-ee-[8px]">
          ...
          <div className="absolute rounded-ss-[8px] rounded-ee-[8px] w-full lg:w-full h-full -z-10 -left-5 -bottom-5 bg-cdark border border-cdark"></div>
          <div className="w-full"></div>
        </div>
        </div>
        <div data-aos="fade-up" data-aos-duration="2000">
        <div className="w-11/12 lg:w-[450px] h-full lg:h-[510px] xxxl:w-[500px] flex flex-col justify-between  m-auto shad bg-white relative border border-[#0D0032] rounded-ss-[8px] rounded-ee-[8px]">
          <Text
          ...
          <div className="absolute rounded-ss-[8px] rounded-ee-[8px] w-full lg:w-full h-full -z-10 -left-5 -bottom-5 bg-corange border border-cdark"></div>
          <div className="w-full"></div>
        </div>
        </div>
        </div>
