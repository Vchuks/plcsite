  ...
  return (
    <div className="bg-[#0D0032] px-4 lg:px-14 pt-10 lg:pt-14  flex flex-col lg:flex-row items-center">
      <div className="w-full pb-10 lg:pb-6 ">
        <p className="w-[80%] lg:w-full xxxl:w-[60%] leading-[1] text-corange font-['aristbold'] text-3xl lg:text-[64px] xxxl:text-[80px]">Excel Masterclass <span className="text-white">[Beginner to Advance]</span></p>
      ...
      <div className="lg:w-[65%] wrapperexcel xxxl:h-[650px] pb-0 lg:pb-10 bg-white  relative rounded-t-[24px]">
      <button
