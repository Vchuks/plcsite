        ...
        <div data-aos="fade-up" data-aos-duration="2000">
          <div className="relative w-11/12 m-auto lg:w-[350px] bg-white border border-black rounded-ss-[30px] rounded-ee-[30px]">
            ...
            <div className="p-4 lg:p-5 font-['gregular'] h-[270px]">
              ...
              <Text
                className="pt-4"
                body="Thousands of Pluralcode’s prospects and students are excited about the possibility of making their dreams come true and you can provide finance these dreams."
              />
            </div>
        ...
        <div data-aos="fade-up" data-aos-duration="2000">
          <div className="relative w-11/12 m-auto lg:w-[350px] bg-white border border-black rounded-ss-[30px] rounded-ee-[30px]">
            ...
            <div className="p-4 lg:p-5 font-['gregular'] h-[270px]">
              ...
              <Text
                className="pt-4"
                body="Join dozens of companies who are building their teams with Pluralcode."
              />
            </div>
            <div className="absolute -z-[1] rounded-ss-[30px] rounded-ee-[30px] w-full h-[90%] -right-3 lg:-right-6 top-5 border border-black bg-white"></div>
          </div>
        ...
        <div data-aos="fade-up" data-aos-duration="2000">
          <div className="relative w-11/12 m-auto lg:w-[350px] bg-white border border-black rounded-ss-[30px] rounded-ee-[30px]">
            ...
            <div className="p-4 lg:p-5 font-['gregular'] h-[270px]">
              ...
              <Text
                className="pt-4"
                body="Become a co-facilitator for one of our SandBox programs and gain recognition while bringing hope and education to thousands of people."
              />
            </div>
            <div className="absolute -z-[1] rounded-ss-[30px] rounded-ee-[30px] w-full h-[90%] -right-3 lg:-right-6 top-5 border border-black bg-white"></div>
          </div>
...
Pluralcode’s army of mentors, trainers and student advisors are on hand to transform your team into an absolute unit with the technical and soft skills you need to win."
              />
            </div>
            <div className="absolute -z-[1] rounded-ss-[30px] rounded-ee-[30px] w-full h-[90%] -right-3 lg:-right-6 top-5 border border-black bg-white"></div>
          </div>
        ...
        <div data-aos="fade-up" data-aos-duration="2000">
          <div className="relative w-11/12 m-auto lg:w-[350px] bg-white border border-black rounded-ss-[30px] rounded-ee-[30px]">
            ...
            <div className="p-4 lg:p-5 font-['gregular'] h-[270px]">
              ...
              <Text
                className="pt-4"
                body="If you believe we share a common  vision, drive and aesthetic, we are willing to work with you and do phenomenal things together."
              />
            </div>
            <div className="absolute -z-[1] rounded-ss-[30px] rounded-ee-[30px] w-full h-[90%] -right-3 lg:-right-6 top-5 border border-black bg-white"></div>
          </div>
...
Hit us up and let’s find common ground and get the message out to your audience. "
              />
            </div>
            <div className="absolute -z-[1] rounded-ss-[30px] rounded-ee-[30px] w-full h-[90%] -right-3 lg:-right-6 top-5 border border-black bg-white"></div>
          </div>
        ...
        <div data-aos="fade-up" data-aos-duration="2000">
          <div className="relative w-11/12 m-auto lg:w-[350px] bg-white border border-black rounded-ss-[30px] rounded-ee-[30px]">
            ...
            <div className="p-4 lg:p-5 font-['gregular'] h-[270px]">
              ...
              <Text
                className="pt-4"
                body="Contact us to find out how this works and build your side-hustle while helping people start a successful tech career."
              />
            </div>
            <div className="absolute -z-[1] rounded-ss-[30px] rounded-ee-[30px] w-full h-[90%] -right-3 lg:-right-6 top-5 border border-black bg-white"></div>
          </div>
