...
const EconomyHero = () => {
  return (
    <div className="flex flex-col items-center lg:flex-row bg-[#F5F6FA] px-4 lg:px-14 pb-4 lg:py-0 gap-6 lg:gap-0">
      ...
      >
        <div className="hidden lg:block absolute w-[70px] -top-2 right-[30%] 2xl:right-[43%] xxxl:right-[50%] xxxl:w-[100px]">
          <Logo src={curve1} alt="" className="w-full" />
        </div>
        <div className="hidden rotate-[320deg] lg:block absolute w-[70px] top-[20%] left-[12%] 2xl:top-[15%] xxxl:top-[20%] xxxl:left-[9%]  xxxl:w-[100px]">
          <Logo src={curve1} alt="" className="w-full" />
        </div>
        ...
        <p className="hero-text 2xl:w-[750px] 2xl:text-7xl leading-tight lg:leading-[1.2] xxxl:leading-[1.3] pt-6 text-cblue xxxl:text-8xl xxxl:w-[1000px]">
          <span className="text-corange">School of</span> Digital Economy
        </p>
        <Text
          ...
          body="The School of Digital Economy is designed for speed, and it is designed for you. This is the faculty that equips you with all the modern skills you need for wealth creation and for professional development. From Content Creation, to sales, to E-commerce, to Creative Design and Growth Marketing, you can learn everything you need in order to be successful in the 21st century and create lasting wealth from the comfort of your home."
        />
      ...
      <div className="w-full" data-aos="zoom-in-up" data-aos-duration="2000">
        <Logo className="lg:w-9/12 xxxl:w-3/4 m-auto" src='https://bulletsaintseverus911.s3.eu-west-3.amazonaws.com/g3.png' alt="" />
      </div>
    </div>
  );
};
