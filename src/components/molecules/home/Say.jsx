            ...
            <div className="testimony 2xl:h-56 2xl:w-11/12 bg-white border border-corange rounded-xl p-4 ">
              <div>
                <div className="flex items-end">
                  <div>
                    <Logo className="w-12" alt="" src={syimg} />
                  </div>
                  <div className="">
                    <Logo src={star} alt="" className="w-20" />
                    <p className=" text-xs text-cblue pt-2 font-['aristbold']">
                      Temiloluwa Abimbola |{" "}
            ...
            <div className="w-full" data-aos="zoom-in-up" data-aos-duration="2000">
              <div className="testimony 2xl:h-56 2xl:w-11/12 bg-white border border-corange rounded-xl p-4">
                <div>
                  <div className="flex items-end">
                    <div>
                      <Logo className="w-12" alt="" src={syimg2} />
                    </div>
                    <div className="">
                      <Logo src={star} alt="" className="w-20" />
                      <p className=" text-xs text-cblue pt-2 font-['aristbold']">
            ...
            <div className="w-full" data-aos="zoom-in-up" data-aos-duration="2000">
              <div className="testimony 2xl:h-56 2xl:w-11/12 bg-white border border-corange rounded-xl p-3">
                <div>
                  <div className="flex items-end">
                    <div>
                      <Logo className="w-12" alt="" src={syimg3} />
                    </div>
                    <div className="">
                      <Logo src={star} alt="" className="w-20" />
                      <p className=" text-xs text-cblue pt-2 font-['aristbold']">
